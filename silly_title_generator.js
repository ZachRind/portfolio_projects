/*
TEMPLATES TO USE
[philosophers] on [philTopic] and [popCulRef]
Understanding [philPhenom] through [philosophers] and [popCulRef]
[verbTitle]: The [philPhenom] in [popCulRef] 
How [popCulRef] illustrates [philosophers]'s concept of [philTopics]
[popCulFig], [philosopher], and [popCulRef]: An/A [Noun (introduction, review, brief history, etc.)]
*/
...
let philPhenom = ['Dialectical Materialism', 'Post-Colonial Theory', 'Hermeneutic Bodies of Knowledge', 'Semiotic Structures', 'Theories of Technology', 'The Evolution of Modern Metaphysics', 'Contemporary Tractatus', 'Pluralism in Ethics', 'Perception and Intentionality', 'Agency and Free Will', 'Epistemologies of Modernism', 'The Mind-Body Probelm'];
